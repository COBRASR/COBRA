...
SUDO = SUDO
sudo_users = {SUDO,1373388290,1084104943}   
print([[
> CH › @CoBBRa_TEAM
~> DEVELOPER › @JO_CR0
~> DEVELOPER › @we_zn
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/COBRATEAM/Files_COBRA/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevCOBRAW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevCOBRAW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevCOBRAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevCOBRAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevCOBRAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1373388290) then  
var = true  
...
os.execute('wget https://raw.githubusercontent.com/COBRASR/COBRA/main/COBRA.lua')
...
if COBRA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *❂︙اسم المستخدم -›* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'CoBBRa_TEAM')..') \n ❂︙'..COBRA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
Text = [[
*أهلاً بك في السوࢪس* [𝑪𝒐𝑩𝒓𝑨 𝒔𝒐𝒓𝒖𝒄𝒆💘]
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السوࢪس 💘',url="https://t.me/CoBBRa_TEAM"},
},
{
{text = 'مطوࢪ السوࢪس 💘',url="t.me/we_zn"},
},
{
{text = 'تواصل السورس 💘',url="t.me/CoBRa_TEAMBOT"},
},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *❂︙بواسطه -›* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'CoBBRa_TEAM')..') \n*❂︙تـم قفـل الدردشه* ')
end,nil)   
...
if DevCOBRAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/COBRATEAM/File_Bot/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/COBRATEAM/Files_COBRA/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*❂︙اسم المستخدم -› ['..data.first_name_..'](t.me/'..(data.username_ or 'COBRA')..') '
...
{{text = '𝑪𝒐𝑩𝒓𝑨 𝑻𝑬𝑨𝑴', url="t.me/COBRATEAM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
send(msg.chat_id_, msg.id_, t..'ٴ❂∫ٴ*•━━━━━━ 𝑩𝑹𝑨 ━━━━━━━•*ٴ❂∫○ٴ\n❂︙[𝑪𝒐𝑩𝒓𝑨 𝑻𝑬𝑨𝑴](t.me/CoBBRa_TEAM) ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑪𝒐𝑩𝒓𝑨 𝑻𝑬𝑨𝑴.',url="t.me/CoBBRa_TEAM"}},
}
local msg_id = msg.id_/2097152/0.5
...
inline = {
{{text = '𝑪𝒐𝑩𝒓𝑨 𝑻𝑬𝑨𝑴',url='http://t.me/CoBBRa_TEAM'}},
}
