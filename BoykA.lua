...
io.popen("cd library && wget https://raw.githubusercontent.com/COBRA-DeV/COBRA/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/CoBBRa_TEAM/Files_COBRA/main/File_Bot/commands.lua") 
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❂︙[تحديثات البوت](t.me/CoBBRa_TEAM) \n❂︙[قناه السورس](t.me/pvv_v)')
end
...
Text = "𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘴𝘰𝘳𝘶𝘤𝘦 𝘊𝘖𝘉𝘙𝘈\n\n[-  𝘊𝘖𝘉𝘙𝘈 𝘊𝘏𝘈𝘕𝘕𝘌𝘓  .](http://t.me/CoBBRa_TEAM)\n\n[-  𝘊𝘖𝘉𝘙𝘈 𝘋𝘌𝘝𝘌𝘓𝘖𝘗𝘌𝘙  .](http://t.me/we_zn)\n\n[-  𝘉𝘖𝘛 𝘊𝘖𝘉𝘙𝘈 .](http://t.me/CoBRa_TEAMBOT)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫: ʙᴏʏᴋᴀ sᴏᴜʀᴄʀ .',url="t.me/CoBBRa_TEAM/567"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/CoBBRa_TEAM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
if DevCOBRAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/COBRA-DeV/Files_COBRA/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/COBRA-DeV/Files_COBRA/main/File_Bot/"..file)
if res == 200 then
...
{{text = '- 𝒔𝒐𝒓𝒖𝒄𝒆 𝒄𝒐𝒃𝒓𝒂', url="t.me/CoBBRa_TEAM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
zh = https.request('https://COBRA-api.ml/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*❂︙قائمه الزخرفه* \nٴ❂∫ٴ*•━━━━━━ 𝑩𝑹𝑨 ━━━━━━━•*ٴ❂∫○ٴ \n"
i = 0
...
gk = https.request('https://COBRA-api.ml/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://COBRA-api.ml/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://COBRA-api.ml/audios.php')
if res == 200 then
...
inline = {
{{text = '𝒔𝒐𝒓𝒖𝒄𝒆 𝒄𝒐𝒃𝒓𝒂',url='http://t.me/CoBBRa_TEAM'}},
}
